...
It keeps JD strategy and resume rewriting separate from the final visual delivery layer: first optimize truthful content, then render it with a VibeResume-inspired HTML-to-PDF page layout.
